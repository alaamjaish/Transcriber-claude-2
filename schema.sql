...
CREATE OR REPLACE FUNCTION "public"."cleanup_old_demo_trials"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."cleanup_old_demo_trials"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_lesson_by_date"("target_student_id" "uuid", "target_date" "date") RETURNS TABLE("id" "uuid", "created_at" timestamp with time zone, "summary_md" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_lessons_in_range"("target_student_id" "uuid", "start_date" timestamp with time zone, "end_date" timestamp with time zone) RETURNS TABLE("id" "uuid", "created_at" timestamp with time zone, "summary_md" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_recent_lessons"("target_student_id" "uuid", "lesson_count" integer DEFAULT 10) RETURNS TABLE("id" "uuid", "created_at" timestamp with time zone, "summary_md" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."hybrid_search_lessons"("query_embedding" "public"."vector", "target_student_id" "uuid", "match_count" integer DEFAULT 10, "min_similarity" double precision DEFAULT 0.7) RETURNS TABLE("id" "uuid", "similarity" double precision, "recency_score" double precision, "final_score" double precision, "summary_md" "text", "created_at" timestamp with time zone, "timestamp" timestamp with time zone)
...
CREATE OR REPLACE FUNCTION "public"."update_demo_trials_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = now();
...
ALTER FUNCTION "public"."update_demo_trials_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."demo_trials" (
    ...
    "last_trial_date" "date" DEFAULT CURRENT_DATE NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."demo_trials" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."demo_trials"
    ADD CONSTRAINT "demo_trials_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_demo_trials_ip_address" ON "public"."demo_trials" USING "btree" ("ip_address");



CREATE UNIQUE INDEX "idx_demo_trials_ip_date" ON "public"."demo_trials" USING "btree" ("ip_address", "last_trial_date");



CREATE INDEX "idx_demo_trials_last_trial_date" ON "public"."demo_trials" USING "btree" ("last_trial_date");
...
CREATE OR REPLACE TRIGGER "update_demo_trials_updated_at" BEFORE UPDATE ON "public"."demo_trials" FOR EACH ROW EXECUTE FUNCTION "public"."update_demo_trials_updated_at"();
...
CREATE POLICY "Allow public insert and select on demo_trials" ON "public"."demo_trials" TO "anon" USING (true) WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."cleanup_old_demo_trials"() TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_old_demo_trials"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_old_demo_trials"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_demo_trials_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_demo_trials_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_demo_trials_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."demo_trials" TO "anon";
GRANT ALL ON TABLE "public"."demo_trials" TO "authenticated";
GRANT ALL ON TABLE "public"."demo_trials" TO "service_role";
